...
C {devices/opin.sym} -110 40 2 0 {name=p5 lab=OUT}
C {devices/iopin.sym} -110 -10 2 0 {name=p6 lab=DVDD}
...
C {devices/lab_pin.sym} 90 -110 0 0 {name=l6 sig_type=std_logic lab=IN2}
...
C {devices/lab_pin.sym} 80 260 3 0 {name=l9 sig_type=std_logic lab=DGND}
C {devices/lab_pin.sym} 400 0 2 0 {name=l1 sig_type=std_logic lab=OUT}
C {devices/lab_pin.sym} 90 -210 0 0 {name=l2 sig_type=std_logic lab=DVDD}
C {sky130_fd_pr/pfet_01v8.sym} 300 -110 0 0 {name=M5
L=0.15
W=1
nf=1
mult=1
...
C {devices/lab_pin.sym} 250 -110 0 0 {name=l3 sig_type=std_logic lab=IN3}
C {sky130_fd_pr/nfet_01v8.sym} 60 220 0 0 {name=M6
L=0.15
W=1
nf=1 
mult=1
...
C {devices/lab_pin.sym} 0 220 0 0 {name=l10 sig_type=std_logic lab=IN3}
C {devices/lab_pin.sym} 120 140 2 0 {name=l11 sig_type=std_logic lab=DGND}
C {devices/ipin.sym} -110 -30 2 1 {name=p2 lab=IN3
}
