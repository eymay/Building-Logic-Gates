...
C {devices/lab_pin.sym} 110 -70 1 0 {name=l6 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 175 -20 2 0 {name=l7 sig_type=std_logic lab=OUT}
...
.endc
"}
C {NAND2_eymenunay.sym} 110 -20 0 0 {name=x1}
C {devices/lab_pin.sym} 60 -40 1 0 {name=l4 sig_type=std_logic lab=IN1}
C {devices/lab_pin.sym} 60 0 3 0 {name=l5 sig_type=std_logic lab=IN2}
